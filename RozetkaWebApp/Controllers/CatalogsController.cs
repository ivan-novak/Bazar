...
namespace RozetkaWebApp.Controllers
{
    public class CatalogsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CatalogId,PortalId,Topic,Discription,Attributes")] Catalog catalog)
        {
            ...
            ViewData["PortalId"] = new SelectList(_context.Portal, "PortalId", "Title", catalog.PortalId);
            return View(catalog);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CatalogId,PortalId,Topic,Discription,Attributes")] Catalog catalog)
        {
