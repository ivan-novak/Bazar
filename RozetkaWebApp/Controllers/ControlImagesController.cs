...
namespace RozetkaWebApp.Controllers
{
    public class ControlImagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ControlImageId,Caption,Path")] ControlImage controlImage)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ControlImageId,Caption,Path")] ControlImage controlImage)
        {
